...
export default function DocsPage() {
  return <main className="docs-page">
    ...
    <header className="docs-hero"><p>Dialogue Lab documentation</p><h1>From first launch to a rendered conversation</h1><span>Dialogue Lab is local-first. A supported cloud provider is required for voice generation; projects and generated assets remain in your private app-data directory.</span></header>
    <div className="docs-layout">
      <aside><a href="#getting-started">Getting started</a><a href="#voices">Voice providers</a><a href="#characters">Characters</a><a href="#dialogue">Dialogue editing</a><a href="#mcp">Connect MCP</a><a href="#privacy">Privacy &amp; backups</a><a href="#roadmap">Roadmap</a></aside>
      <article>
        ...
        <section id="mcp"><h2>Connect an MCP client</h2><p>After the npm package is published, register <code>npx -y dialoguelab-mcp</code> as a stdio MCP server. From a checkout, run <code>npm run build:mcp</code> and point the client at <code>packages/dialoguelab-mcp/dist/cli.js</code>.</p><p>The app and MCP package use the same OS app-data directory by default. Set <code>DIALOGUELAB_DATA_DIR</code> on both when using a custom profile.</p></section>
